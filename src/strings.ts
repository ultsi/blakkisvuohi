...
export const commands = {
    ...
    start: {
        ...
        header_user: emoji.goat + ' *Bäää - {title}* ' + emoji.goat + '\n\n*Nyt:* {permilles}‰ - *30min:* {permilles30Min}‰\n\n',
        header_nonuser: emoji.goat + ' *Bäää - {title}* ' + emoji.goat + '\n\n',
        header_title: 'Bläkkisvuohi',
        on_select_drinks3h: '\n\nViimeisen kolmen tunnin tapahtumat:\n{drinkList3h}',
        juo: {
            button_text: emoji.glasses + ' Juo',
            header: emoji.goat + ' *Bäää - {title}* ' + emoji.goat + '\n\n*Nyt:* {permilles}‰ - *30min:* {permilles30Min}‰\n{drink_list}\n',
            ...
            miedot: {
                button_text: emoji.beers + ' Miedot',
                header_title: 'Miedot',
                on_select: 'Valitse mieto.',
            },
            viinit: {
                button_text: emoji.wine + ' Viinit',
                header_title: 'Viinit',
                on_select: 'Valitse viini.',
            },
            shotit: {
                button_text: emoji.shot + ' Shotit',
                header_title: 'Shotit',
                on_select: 'Valitse shotti.',
            },
            oma: {
                button_text: emoji.memo + ' Oma juoma',
            ...
            jalkikellotus: {
                button_text: emoji.stopwatch + ' Jälkikellotus',
        ...
        asetukset: {
            ...
            muokkaa: {
                ...
                pituus: {
                    button_text: emoji.ruler + ' Muokkaa pituutta',
            ...
            paivita: {
                button_text: emoji.refresh + ' Päivitä nimi',
        ...
        luo_tunnus: {
            button_text: emoji.glowing_star + ' Luo tunnus',
        ...
        tilastoja: {
            button_text: emoji.bar_graph + ' Tilastoja',
