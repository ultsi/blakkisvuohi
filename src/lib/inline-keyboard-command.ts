...
export default class InlineKeyboardCommand {
    public commandName: string
    public parent: InlineKeyboardCommand|boolean
    private root: boolean
    private userRequired: boolean
    private adminRequired: boolean
    private nonUserRequired: boolean
    private text: string
    private onSelectAction: Function
    private onTextAction: Function
    private onExitAction: Function
    private isAvailableAction: Function
    private formHeader: Function
    private headerTitle: string
    private children: object
    private childrenArray: InlineKeyboardCommand[]

    constructor(definition, commandName, parent = null) {
        if (!parent) {
            if (!definition._root) {
